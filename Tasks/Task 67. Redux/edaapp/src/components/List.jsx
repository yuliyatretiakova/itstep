            ...
            <tbody>
                {
                    props.products.map((item, index) => {
                        return <tr key={item.id}>
                            ...
                            <td>{item.quantity}</td>
                            <td>{item.unit}</td>
                            <td>{item.favorite == false &&
                                <button className="button_dislike" data-id={item.id} onClick={handleLikeClick} >
                                ...
                                {item.favorite == true &&
                                    <button className="button_like" data-id={item.id} onClick={handleDislikeClick} >
